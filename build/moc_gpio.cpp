...
QT_MOC_LITERAL(1, 5, 12), // "inputChanged"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 5), // "value"
QT_MOC_LITERAL(4, 25, 7), // "pinHigh"
QT_MOC_LITERAL(5, 33, 6), // "pinLow"
QT_MOC_LITERAL(6, 40, 9), // "pinToggle"
QT_MOC_LITERAL(7, 50, 11) // "setPwmValue"

    },
    "GPIO\0inputChanged\0\0value\0pinHigh\0"
    "pinLow\0pinToggle\0setPwmValue"
};
...
void GPIO::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->pinHigh(); break;
        case 2: _t->pinLow(); break;
        case 3: _t->pinToggle(); break;
        case 4: _t->setPwmValue((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GPIO::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GPIO::inputChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GPIO::inputChanged(int _t1)
{
