...
Rectangle
{
    ...
    Rectangle
    {
        ...
        ItemParameter
        {
            ...
            onSendParameter:
            {
                stepper2.ThresholdSpeed = paramValue;
            }
        }
        ...
        ItemParameter
        {
            ...
            onSendParameter:
            {
                stepper2.Acceleration = paramValue;
            }
        }
        ...
        ItemParameter
        {
            ...
            onSendParameter:
            {
                stepper2.Deceleration = paramValue;
            }
        }
    ...
    Rectangle
    {
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                stepper2.StepMode = stepMODE_FULL_STEP;
            }
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                rbStpMode64uStep.active = false;
                rbStpMode128uStep.active = false;
                stepper2.StepMode = stepMODE_HALF_STEP;
            }
        }
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                rbStpMode64uStep.active = false;
                rbStpMode128uStep.active = false;
                stepper2.StepMode = stepMODE_uSTEP_4;
            }
        }
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                rbStpMode64uStep.active = false;
                rbStpMode128uStep.active = false;
                stepper2.StepMode = stepMODE_uSTEP_8;
            }
        }
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                rbStpMode64uStep.active = false;
                rbStpMode128uStep.active = false;
                stepper2.StepMode = stepMODE_uSTEP_16;
            }
        }
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                rbStpMode64uStep.active = false;
                rbStpMode128uStep.active = false;
                stepper2.StepMode = stepMODE_uSTEP_32;
            }
        }
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                rbStpMode128uStep.active = false;
                stepper2.StepMode = stepMODE_uSTEP_64;
            }
        }
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                stepper2.StepMode = stepMODE_uSTEP_128;
            }
        }
    ...
    Connections
    {
        ...
        onMaxSpeedChanged:
        {
            param_maxSpeed.paramValue = stepper2.MaxSpeed;
        }

        onThresholdSpeedChanged:
        {
            param_thrSpeed.paramValue = stepper2.ThresholdSpeed;
        }

        onAccelerationChanged:
        {
            param_acceleration.paramValue = stepper2.Acceleration;
        }

        onDecelerationChanged:
        {
            param_deceleration.paramValue = stepper2.Deceleration;
        }

        onKValHoldChanged:
        {
            param_holdTorque.paramValue = stepper2.KValHold;
        }

        onKValAccChanged:
        {
            param_accTorque.paramValue = stepper2.KValAcc;
        }

        onKValRunChanged:
        {
            param_runTorque.paramValue = stepper2.KValRun;
        }

        onKValDecChanged:
        {
            param_decTorque.paramValue = stepper2.KValDec;
        }

        onStepModeChanged:
        {
            switch(stepper2.StepMode)
            {
